...
# --- 远程脚本和日志配置 ---
OUTPUT_DIR="$PROJECT_DIR/work_dir/opg_qwen25_32b_cot_lt_48k/"
REMOTE_MAIN_SCRIPT="$PROJECT_DIR/scripts/launch_multi_nodes_full.sh"
REMOTE_SCRIPT="$PROJECT_DIR/scripts/launch_single_node.sh"
TRAIN_SCRIPT="$PROJECT_DIR/scripts/opg_qwen25_32b.sh"
# TRAIN_SCRIPT="$PROJECT_DIR/scripts/sft_qwen25_32b.sh"
