...
# --- 训练相关参数，来自你原始脚本的配置 ---
PROJECT_DIR="/root/llmtuner/llm/MindSpeed-LLM"
DATA_PATH="/root/llmtuner/hfhub/mindspeed/datasets/SimPO_V2/mcore/am-thinking_dpo_dataset"
TOKENIZER_PATH="/root/llmtuner/hfhub/models/Qwen/Qwen2.5-32B"
CKPT_LOAD_DIR="/root/llmtuner/hfhub/mindspeed/models/mindspore/hf_sft_packing_0703_step6476_to_mcore/mcore_tp8_pp4"
...
# --- 远程脚本和日志配置 ---
OUTPUT_DIR="$PROJECT_DIR/work_dir/PCL-Reasoner-SimPO-am-thinking_exp4"
REMOTE_MAIN_SCRIPT="$PROJECT_DIR/scripts/scripts_simpo/qwen25_32b/launch_multi_nodes_full.sh"
REMOTE_SCRIPT="$PROJECT_DIR/scripts/scripts_simpo/qwen25_32b/launch_single_node.sh"
TRAIN_SCRIPT="$PROJECT_DIR/scripts/scripts_simpo/qwen25_32b/simpo_qwen25_32b_32k_ptd.sh"
# TRAIN_SCRIPT="$PROJECT_DIR/scripts/scripts_simpo/qwen25_32b/simpo_qwen25_32b_32k_ptd_debug.sh"
